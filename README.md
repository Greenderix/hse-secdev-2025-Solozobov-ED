...
- **ФИО:** TODO: Солозобов Евгений Дмитриевич
- **Группа:** TODO: БПИ-20-01
- **Контакт:** TODO: `edsolozobov@edu.hse.ru` / `@grinderix`
- **Опционально: свой проект (BYO):** Система автоматизации поиска работы - https://github.com/vecnick/hh
- **Совместная работа в группе с Верховод Никита Сергеевич**
